...
// Generate safe list for grid columns (grid-cols-2 to grid-cols-4) used by Grid
const gridColsSafeList = ['grid-cols-2', 'grid-cols-3', 'grid-cols-4'];
...
export default {
    ...
    safelist: [ // Add safe list here
        ...
        ...gridColsSafeList,
        ...gapSafeList,
         // Add specific aspect ratio classes if needed, though usually generated by default
        'aspect-video',
        'aspect-[4/3]',
        'aspect-square',
        'aspect-[9/16]',
